...
Running this experiment taught me the following about the realities of training physics-informed AI models:
...
Following is the link to directly run my Python code in Google Colab platform :
